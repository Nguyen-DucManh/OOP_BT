...
public class Circle extends Shape{
    ...
    void update() {
        ...
        if (center.getPointX() + size > mainFrame.getWidth()) {
            center.setPointX(mainFrame.getWidth() - size);
            vx *= -1;
        }

        if (center.getPointY() + 1.75 * size > mainFrame.getHeight()) {
            center.setPointY(mainFrame.getHeight() - 1.75 * size);
            vy *= -1;
        }
