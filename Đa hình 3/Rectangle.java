...
public class Rectangle extends Shape {
    ...
    void update() {
        ...
        if (topLeft.getPointY()  > mainFrame.getHeight() - 1.75 * length || topLeft.getPointY() < 0) {
            vy *= -1;
        }

        if (topLeft.getPointX() + side > mainFrame.getWidth() - width) {
        ...
        if (topLeft.getPointY() + 1.75 * side > mainFrame.getHeight() - length) {
